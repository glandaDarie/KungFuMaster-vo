...
def main(enabled_render_mode: bool = True) -> None:
    env : gym.Env[np.ndarray, np.ndarray | int] = \
        gym.make("CartPole-v0", render_mode="human") if enabled_render_mode else gym.make("CartPole-v0") 
